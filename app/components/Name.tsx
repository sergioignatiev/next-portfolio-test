...
export function Name(){
  ...
  <InVievLeft duration={0.1}>  <div className="text-[red]"> W</div></InVievLeft>
    ...
    <InVievLeft duration={0.4}>  <div className=""> -</div></InVievLeft>
    ...
    <InVievLeft duration={0.7}><div className="">V</div></InVievLeft>
    <InVievLeft duration={0.8}><div className="">E</div></InVievLeft>
    <InVievLeft duration={0.9}><div className="">L</div></InVievLeft>
    <InVievLeft duration={1}>  <div className="">O</div></InVievLeft>
    <InVievLeft duration={1.1}><div className="">P</div></InVievLeft>
    <InVievLeft duration={1.2}><div className="">E</div></InVievLeft>
    <InVievLeft duration={1.3}><div className="">R</div></InVievLeft>
